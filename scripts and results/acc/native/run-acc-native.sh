...
run_top() {
        echo "run number $1"
        $adb shell "top -bd1 -o res,%cpu,%mem,args -m 200 | grep losalv.android | grep -v grep" >> ./measures1.txt
}
...
$adb shell am start -W -n \
        "losalv.android.masterthesisnativeartifact/losalv.android.masterthesisnativeartifact.AccelerometerActivity" \
...
take-screenshot
$adb shell am force-stop losalv.android.masterthesisnativeartifact
$adb shell pm clear losalv.android.masterthesisnativeartifact
